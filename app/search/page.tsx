...
import { Search, MapPin, Star, Phone, Clock, ArrowLeft } from "lucide-react"
...
export default function SearchPage() {
  ...
  const categories = ["All", "Hospital", "Clinic", "Pharmacy", "Dental", "Eye Care", "Gym"]
  const areas = ["All Areas", "Blantyre City", "Limbe", "Chichiri", "Mandala", "Nyambadwe"]
