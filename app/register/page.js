      ...
      <section className="py-12 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Stay Informed</h1>
            <p className="text-lg text-gray-600">Subscribe to receive health tips and provider updates</p>
          </div>

          <Card>
            <CardHeader>
              <CardTitle>Subscribe to Health Updates</CardTitle>
              <CardDescription>Fill in your details to get personalized health information</CardDescription>
            </CardHeader>
            <CardContent>
